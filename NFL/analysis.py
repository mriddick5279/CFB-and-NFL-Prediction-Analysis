...
"""
parser = argparse.ArgumentParser(description="Load NFL season file")

parser.add_argument("year", type=str, help="NFL season year of file to analyze")
...
plt.yticks(fontsize=10)
plt.legend(["Correct", "Incorrect"])
plt.savefig("Outputs\\afc_wins_and_losses_plot.png")
plt.close()
